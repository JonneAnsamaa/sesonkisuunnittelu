...
function runScheduler() {
  ...
  const s23=sessions.find(s=>s.id==='session-23');if(s23)s23.duration=60;
  const s37=sessions.find(s=>s.id==='session-37');if(s37)s37.topic=s37.topic.replace('meeting 3','meeting 4');
  ...
  const forcePlacements=[{id:'session-1',day:1,startTime:'10:00',endTime:'11:30',room:'k1-01'},{id:'session-30',day:1,startTime:'10:30',endTime:'11:30',room:'k1-02'},{id:'session-23',day:3,startTime:'09:00',endTime:'10:00',room:'k1-13'}];
